...
1. **复制方法**: 每个图表都是独立的，您可以单独复制每个 ```mermaid 代码块
2. **Mermaid Live Editor**: https://mermaid.live/
3. **GitHub**: 直接在GitHub上查看，会自动渲染
4. **VS Code**: 安装Mermaid扩展后可以直接预览

每个图表都专注于不同的方面，您可以根据需要选择使用哪些图表！
